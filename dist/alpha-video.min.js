...
/******/ 	return __webpack_require__(__webpack_require__.s = "./lib/alpha-video.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!***************************************************!*\
  !*** ./node_modules/lit-html/lib/lit-extended.js ***!
  \***************************************************/
/*! exports provided: render, BooleanAttributePart, EventPart, html, svg, LitExtendedTemplateProcessor, templateProcessor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"html\", function() { return html; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"svg\", function() { return svg; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"LitExtendedTemplateProcessor\", function() { return LitExtendedTemplateProcessor; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"templateProcessor\", function() { return templateProcessor; });\n/* harmony import */ var _core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core.js */ \"./node_modules/lit-html/core.js\");\n/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lit-html.js */ \"./node_modules/lit-html/lit-html.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"render\", function() { return _core_js__WEBPACK_IMPORTED_MODULE_0__[\"render\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"BooleanAttributePart\", function() { return _lit_html_js__WEBPACK_IMPORTED_MODULE_1__[\"BooleanAttributePart\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"EventPart\", function() { return _lit_html_js__WEBPACK_IMPORTED_MODULE_1__[\"EventPart\"]; });\n\n/**\n * @license\n * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.\n * This code may only be used under the BSD style license found at\n * http://polymer.github.io/LICENSE.txt\n * The complete set of authors may be found at\n * http://polymer.github.io/AUTHORS.txt\n * The complete set of contributors may be found at\n * http://polymer.github.io/CONTRIBUTORS.txt\n * Code distributed by Google as part of the polymer project is also\n * subject to an additional IP rights grant found at\n * http://polymer.github.io/PATENTS.txt\n */\n\n\n\n\n/**\n * Interprets a template literal as a lit-extended HTML template.\n */\nconst html = (strings, ...values) => new _core_js__WEBPACK_IMPORTED_MODULE_0__[\"TemplateResult\"](strings, values, 'html', templateProcessor);\n/**\n * Interprets a template literal as a lit-extended SVG template.\n */\nconst svg = (strings, ...values) => new _core_js__WEBPACK_IMPORTED_MODULE_0__[\"SVGTemplateResult\"](strings, values, 'svg', templateProcessor);\n/**\n * A PartCallback which allows templates to set properties and declarative\n * event handlers.\n *\n * Properties are set by default, instead of attributes. Attribute names in\n * lit-html templates preserve case, so properties are case sensitive. If an\n * expression takes up an entire attribute value, then the property is set to\n * that value. If an expression is interpolated with a string or other\n * expressions then the property is set to the string result of the\n * interpolation.\n *\n * To set an attribute instead of a property, append a `$` suffix to the\n * attribute name.\n *\n * Example:\n *\n *     html`<button class$=\"primary\">Buy Now</button>`\n *\n * To set an event handler, prefix the attribute name with `on-`:\n *\n * Example:\n *\n *     html`<button on-click=${(e)=> this.onClickHandler(e)}>Buy Now</button>`\n *\n * @deprecated Please use /lit-html.js instead. lit-extended will be removed in\n *     a future version.\n */\nclass LitExtendedTemplateProcessor extends _core_js__WEBPACK_IMPORTED_MODULE_0__[\"TemplateProcessor\"] {\n    handleAttributeExpressions(element, name, strings) {\n        if (name.substr(0, 3) === 'on-') {\n            const eventName = name.slice(3);\n            return [new _lit_html_js__WEBPACK_IMPORTED_MODULE_1__[\"EventPart\"](element, eventName)];\n        }\n        const lastChar = name.substr(name.length - 1);\n        if (lastChar === '$') {\n            const comitter = new _core_js__WEBPACK_IMPORTED_MODULE_0__[\"AttributeCommitter\"](element, name.slice(0, -1), strings);\n            return comitter.parts;\n        }\n        if (lastChar === '?') {\n            return [new _lit_html_js__WEBPACK_IMPORTED_MODULE_1__[\"BooleanAttributePart\"](element, name.slice(0, -1), strings)];\n        }\n        const comitter = new _lit_html_js__WEBPACK_IMPORTED_MODULE_1__[\"PropertyCommitter\"](element, name, strings);\n        return comitter.parts;\n    }\n}\nconst templateProcessor = new LitExtendedTemplateProcessor();\n//# sourceMappingURL=lit-extended.js.map\n\n//# sourceURL=webpack:///./node_modules/lit-html/lib/lit-extended.js?");
